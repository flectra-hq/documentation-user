...
.. note::
    ...
    * Once again the system is smart. If a rule is set for a particular item and another one for its category, Flectra will take the rule of the item.
...
Any new customer recorded in Flectra gets a default pricelist, i.e. the first one in the list matching the country. In case no country is set for the customer, Flectra takes the first pricelist without any country group.
