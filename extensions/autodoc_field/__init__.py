...
class OdooClassDocumenter(ClassDocumenter):
    ...
    def can_document_member(cls, member, membername, isattr, parent):
        return isinstance(member, flectra.models.MetaModel)
...
class FieldDocumenter(AttributeDocumenter):
    ...
    @classmethod
    def can_document_member(cls, member, membername, isattr, parent):
        return isinstance(member, flectra.fields.Field)
    ...
    def update_annotations(self, parent):
        ...
        if field.type == 'many2one':
            ...
            annotation[attrname] = Sequence[flectra.fields.Command]
    ...
    def add_content(self, more_content):
        ...
        if field.default:
            self.add_line(f":default: {field.default(flectra.models.Model)}", source_name)
