...
.. raw:: html
   ...
   <span class="badge" style="background-color:#AD5E99">Flectra feature</span>

The Flectra theme supports banner images at the top of documents. At the first line of your documents,
...
+-------------------+------------------------------------------+-----------------------------------------------------------+-------------------------------------------------------+
| ``file``          | Indicate a file path                     | ``:file:`~/flectra/flectra-bin```                         | :file:`~/flectra/flectra-bin`                         |
+-------------------+------------------------------------------+-----------------------------------------------------------+-------------------------------------------------------+
