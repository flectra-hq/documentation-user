...
if not odoo_dir.is_dir():
    ...
    if release != odoo_version:
        _logger.warning(
            ...
            f" with `cd flectra && git checkout {version}`."
        )
    else:
...
html_theme = 'flectra_theme'

# The name of the Pygments (syntax highlighting) style to use.
# See extensions/flectra_theme/pygments_override.py
...
def _generate_alternate_urls(app, pagename, templatename, context, doctree):
    ...
    def _canonicalize():
        ...
        E.g.:
        - /documentation/sale.html -> canonical = /documentation/2.0/sale.html
        - /documentation/11.0/fr/website.html -> canonical = /documentation/2.0/fr/website.html
        """
