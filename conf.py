...
project = u'Flectra'
copyright = u'2015-TODAY, Flectra S.A.'
...
latex_additional_files = ['_static/latex/flectra.sty']

# Grouping the document tree into LaTeX files. List of tuples
# (source start file, target name, title,
#  author, documentclass [howto, manual, or own class]).
latex_documents = [
  ('legal/terms/enterprise_tex', 'flectra_enterprise_agreement.tex', 'Flectra Enterprise Subscription Agreement', '', 'howto'),
  ('legal/terms/partnership_tex', 'flectra_partnership_agreement.tex', 'Flectra Partnership Agreement', '', 'howto'),
  ('legal/terms/terms_of_sale', 'terms_of_sale.tex', 'Flectra Terms of Sale', '', 'howto'),

  ('legal/terms/i18n/enterprise_tex_fr', 'flectra_enterprise_agreement_fr.tex', 'Flectra Enterprise Subscription Agreement (FR)', '', 'howto'),
  ('legal/terms/i18n/partnership_tex_fr', 'flectra_partnership_agreement_fr.tex', 'Flectra Partnership Agreement (FR)', '', 'howto'),
  ('legal/terms/i18n/terms_of_sale_fr', 'terms_of_sale_fr.tex', u'Conditions Générales de Vente Flectra', '', 'howto'),

  ('legal/terms/i18n/enterprise_tex_nl', 'flectra_enterprise_agreement_nl.tex', 'Flectra Enterprise Subscription Agreement (NL)', '', 'howto'),
  #('legal/terms/i18n/partnership_tex_nl', 'flectra_partnership_agreement_nl.tex', 'Flectra Partnership Agreement (NL)', '', 'howto'),

  ('legal/terms/i18n/enterprise_tex_de', 'flectra_enterprise_agreement_de.tex', 'Flectra Enterprise Subscription Agreement (DE)', '', 'howto'),
  #('legal/terms/i18n/partnership_tex_de', 'flectra_partnership_agreement_de.tex', 'Flectra Partnership Agreement (DE)', '', 'howto'),

  ('legal/terms/i18n/enterprise_tex_es', 'flectra_enterprise_agreement_es.tex', 'Flectra Enterprise Subscription Agreement (ES)', '', 'howto'),
  ('legal/terms/i18n/partnership_tex_es', 'flectra_partnership_agreement_es.tex', 'Flectra Partnership Agreement (ES)', '', 'howto'),
...
# the title page.
latex_logo = '_static/icons/flectra_logo.png'
...
flectra_cover_external = {}

gitlab_user = 'flectra'
gitlab_project = 'documentation-user'
