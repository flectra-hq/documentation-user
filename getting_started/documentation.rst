...
This document summarizes Flectra Online's services, our Success Pack
...
-  **The Flectra Consultant ensures the project implementation from A to Z**:
   From the beginning to the end of the project, he ensures the overall
   consistency of the implementation in Flectra and shares his expertise
...
-  **Meetings optimization**:
   The Flectra consultant is not involved in the process of decision
   ...
   the way those needs will be implemented in Flectra (Consultant).

-  **Train the Trainer approach**:
   The Flectra consultant provides functional training to the SPoC so that
   ...
   the :doc:`Flectra documentation <../index>`,
   `The elearning platform <https://flectra.com/learn>`_
...
-  **Phasing the project**:
   ...
   regular production releases and an evolving takeover of Flectra by the
...
-  **Adopting standard features as a priority**:
   Flectra offers a great environment to implement slight improvements
...
-  **Align with the project approach**:
   ...
   etc.) are crucial to the success of an Flectra implementation. It is
...
-  **The GAP Analysis**: The comparison of the request with the standard
   features proposed by Flectra will make it possible to identify the
...
Flectra is a software known for its flexibility and its important evolution
...
-  **Develop only for a good reason**:
   ...
   Flectra (see "Adopting the standard as a priority").
...
-  **Not to import anything**:
   ...
   Flectra and consolidated for later reporting.
...
-  **To import after production launch**:
   When the data history needs to be integrated with Flectra mainly for
