...
#. Double-check your :abbr:`PR (Pull Request)` and, when ready, click again on the **Create pull
   request** button to submit your changes for review by a content writer at Flectra.
...
files. As it would not be convenient to have several people working on the version2.0 in parallel
...
<https://www.atlassian.com/git/tutorials/using-branches>`_ starting from the branch2.0. In other
...
#. Switch to the version2.0:

   .. code-block:: console

      $ git checkout2.0

#. Create your own branch which will be a copy of2.0:

   .. code-block:: console

      $ git checkout -b2.0-my_contribution
