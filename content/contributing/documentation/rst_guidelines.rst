...
#. Absolute:
   ...
   - ``https://flectra.com/documentation/{BRANCH}/applications/sales/sales/products_prices/prices.html``
   - ``https://flectra.com/documentation/{BRANCH}/applications/sales/sales/products_prices/products/variants.html``
...
.. code-block:: rst
   ...
   To register your seller account in Flectra, go to :menuselection:`Sales --> Configuration --> Settings
