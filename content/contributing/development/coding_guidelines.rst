...
In Flectra, the use of CSS variables is strictly DOM-related. Use them to **contextually** adapt the
design and layout.
...
In Flectra, the use of CSS variables is strictly DOM-related, meaning that are used to **contextually**
...
In Flectra, we take the best of both worlds: using the `SCSS` variables to define the design-system
...
Flectra's UI. The practice is commonly used to access and modify CSS variables globally. We perform
