...
With **Flectra Subscriptions**, you can have all your subscriptions in one application, suggest an
...
.. image:: renewals/renew-your-subscription.png
  :align: center
  :alt: Renew your subscription with Flectra Subscriptions
...
.. important::
   ...
   .. image:: renewals/customer-preview-of-a-renewal.png
     :align: center
     :alt: Customer preview of a renewal with Flectra Subscriptions
...
.. note::
   ...
   .. image:: renewals/renew-a-quotation.png
     :align: center
     :alt: Renew a quotation with Flectra Subscriptions
   ...
   *Subscription Management* category. There, you can easily visualize which one is your renewal.
   ...
   .. image:: renewals/subscription-management-category.png
     :align: center
     :alt: Renewal as Subscription Management form in Flectra Subscriptions
...
.. image:: renewals/subscriptions-dashboard-with-the-to-renew-filter.png
  :align: center
  :alt: List view of all subscriptions and use of the filter to renew in Flectra Subscriptions
