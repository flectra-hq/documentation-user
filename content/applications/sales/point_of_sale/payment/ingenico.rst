...
Connecting an Ingenico Payment Terminal to Flectra is a feature that
...
*IoT Box* form in Flectra and verify that the terminal has been found.
...
order in Flectra even if the connection between the terminal and Flectra has
issues.
