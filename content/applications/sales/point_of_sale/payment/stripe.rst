...
Connect Stripe to Flectra
-------------------------

Click :guilabel:`Connect Stripe`. Doing so redirects you automatically to a configuration page.
Fill in all the information to create your Stripe account and link it with Flectra. Once the forms are
...
click the keys to copy them, and paste them into the corresponding fields in Flectra. Your terminal is
...
.. note::
   ...
   - Your Flectra database and payment terminal must share the same network.
...
.. note::
   - | In case of connection issues between Flectra and the payment terminal, force the payment by
