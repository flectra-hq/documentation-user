...
:guilabel:`Force Done` button. This will allow you to validate the order in Flectra even if there are
connection issues between the payment terminal and Flectra.
