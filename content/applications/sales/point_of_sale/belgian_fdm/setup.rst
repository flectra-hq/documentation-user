======================================================
Setting up the Fiscal Data Module with the Flectra POS
======================================================
...
An Flectra POS app can be given certified POS capabilities by installing
...
certified Flectra POS has some limitations not present in the
non-certified Flectra POS.
...
* Multiple Flectra POS configurations per IoT Box are not allowed
