...
In Flectra Accounting, each bank account has a dedicated journal set to post all entries in a dedicated
...
If your banking institution is not available in Flectra, or if you don't want to connect your bank
...
.. note::
   - Flectra automatically detects the bank account type (e.g., IBAN) and enables some features
     accordingly.
