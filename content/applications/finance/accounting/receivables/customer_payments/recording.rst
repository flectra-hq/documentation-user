...
In Flectra, payments can either be linked automatically to an invoice or bill or be stand-alone records
...
.. seealso::
   ...
   - `Flectra Tutorials: Bank Configuration
     <https://www.flectra.com/slides/slide/bank-configuration-1880>`_
...
.. note::
   ...
   - If your main bank account is set as :doc:`outstanding account
     <../../bank/setup/outstanding_accounts>`, and the payment is made in Flectra (not related to a
