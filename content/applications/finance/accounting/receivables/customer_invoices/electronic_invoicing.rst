...
Flectra supports, among others, the following formats.
...
.. note::
   ...
   - Every PDF generated from Flectra contains a :guilabel:`Factur-X` XML file (for interoperability purpose).
   ...
   - The formats available depend on the country registered in your company's :guilabel:`General
     Information`.
   - Flectra supports the **Peppol BIS Billing 3.0** format that can be used via existing access
     points.
