...
When paying a bill in Flectra, you can select SEPA mandates as a payment option. At the day's end,
...
Flectra. The bank reconciliation process will seamlessly match the SEPA orders you sent to your bank
...
Account` field with the bank name, IBAN, and BIC (Bank Identifier Code). Flectra automatically verifies
if the IBAN format is respected.

For future payments to this vendor, Flectra will automatically suggest you the bank account, but it
