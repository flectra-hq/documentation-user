...
Flectra provides multi-currency support with automatic currency gross or
loss entry adjustment. There are a few things Flectra has been to ease the
user's life.
...
however Flectra takes the company currency as a default assignment. It will
