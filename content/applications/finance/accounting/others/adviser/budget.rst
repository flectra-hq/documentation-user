...
performance against the plan. Flectra manages budgets using both **general** and **analytic accounts**.
...
Flectra needs to know which costs or expenses are relevant to a specified budget, as the above general
