...
Flectra comes with a powerful and easy-to-use reporting framework. The engine allows you to create new
...
'Flectra Domain' engine
-----------------------

With this engine, a formula is interpreted as an :ref:`Flectra domain <reference/orm/domains>`
