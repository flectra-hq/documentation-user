...
The configuration of the **Tax Return Periodicity** allows Flectra Accounting to compute your Tax
...
- **Reminder**: define when Flectra should remind you to file your tax return.
- **Journal**: select the journal in which to record the tax return.

.. image:: media/tax_return_periodicity.png
   :align: center
   :alt: Configure how often tax returns have to be made in Flectra Accounting
...
Flectra generates Tax Reports based on the **Tax Grids** settings that are configured on your taxes.
...
.. image:: media/tax_return_grids.png
   :align: center
   :alt: see which tax grids are used to record transactions in Flectra Accounting
...
.. image:: media/tax_return_taxes.png
   :align: center
   :alt: Configure taxes and their tax grids in Flectra Accounting
...
.. image:: media/tax_return_lock.png
   :align: center
   :alt: Lock your tax for a specific period in Flectra Acounting
...
.. image:: media/tax_return_closing.png
   :align: center
   :alt: Select the period for the tax return and create a closing journal entry in Flectra Accounting

After having reviewed the generated Journal Entry, click on *Post*. In addition to posting the entry,
Flectra automatically creates a PDF file with the **Tax Report** that you can download from the chatter
...
.. image:: media/tax_return_report.png
   :align: center
   :alt: download the PDF with your Tax Report in Flectra Accounting

.. note::
   If you forgot to :ref:`lock your tax date <tax_return_lock>` before clicking on *Closing Journal
   Entry*, then Flectra automatically locks your fiscal period on the same date as the Accounting Date
