...
The configuration of the **Tax Return Periodicity** allows Flectra to compute your tax return correctly
...
- :guilabel:`Periodicity`: define here whether you submit your tax return on a monthly or quarterly
  basis;
- :guilabel:`Reminder`: define when Flectra should remind you to submit your tax return;
...
Flectra generates tax reports based on the :guilabel:`Tax Grids` settings that are configured on your
...
.. note::
   Taxes and reports are usually already pre-configured in Flectra: a :ref:`fiscal localization package
...
.. image:: tax_returns/tax_return_lock.png
   :align: center
   :alt: Lock your tax for a specific period in Flectra Accounting
...
.. note::
   ...
   Flectra automatically locks your fiscal period on the same date as the accounting date of your
