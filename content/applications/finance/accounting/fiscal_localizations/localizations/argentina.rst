...
The Argentinean localization has been improved and extended in Flectra v13, in this version the next
...
#. Generate certificate Sign Request (Flectra). When this option is selected a file with extension
...
#. Upload Certificate and Private Key (Flectra). Once the certificate has been generated, it needs to
   be uploaded in Flectra, using the pencil next in the field “Certificado” and selecting the
   corresponding file.
...
.. note::
   The complete list of Identification types defined by the AFIP is included in Flectra but only the
...
Sequences
~~~~~~~~~
In case that you want to synchronize the next number in the sequence in Flectra based on the next
...
Proveedor del Exterior” or “IVA Liberado – Ley Nº 19.640”, Flectra automatically assigned:
...
as support for any possible  issues on the sequence synchronization between Flectra and AFIP. 
