...
3. The final response from the SII, can take on of these values:
   ...
   **Rejected:** Indicates the information in the invoice is incorrect and needs to be
   ...
   SII, if it is properly configured in Flectra, the details are also retrieved
...
credit and debit notes, they are set automatically by Flectra:
...
Once the invoice has been Accepted by the SII **it can not be cancelled in Flectra**.  In case you
...
- GLOSA: ``Usuario sin permiso de envio.``
  ...
  *Hint:* This error indicates that most likely, your company has not passed the `Certification
  ...
  Manager or Customer Support as this certification is not part of the the Flectra services,
