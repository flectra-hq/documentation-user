...
**Flectra Invoicing** is a standalone invoicing app that allows you to :doc:`issue invoices
...
<accounting/receivables/customer_payments/online_payment>`. It works as a "lighter" version of Flectra
Accounting, and you can upgrade it to Flectra Accounting if you need more advanced accounting features.

**Flectra Accounting** is a complete and strong accounting app. The automation of processes is at the
core of its development with its perfect integration with all Flectra apps and with features such as
