...
In Flectra, there are several Spanish Chart of Accounts that are available by default:
...
.. tip::
    When you create a new Flectra Online database, the PGCE PYMEs 2008 is installed by default.
