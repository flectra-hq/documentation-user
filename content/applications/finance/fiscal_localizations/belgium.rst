...
The Flectra POS system is certified for the major versions of databases hosted on **Flectra Online** and
**Flectra.sh**. Please refer to the following table to ensure that your POS system is certified.
...
must contact us through our `support contact form <https://www.flectra.com/help>`_ and provide the
