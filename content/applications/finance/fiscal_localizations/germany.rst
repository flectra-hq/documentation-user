...
.. tip::
    ...
    When you create a new Flectra Online database, the SKR03 is installed by default.
...
Flectra offers a service that is compliant with the help of `fiskaly <https://fiskaly.com>`_, a
...
.. image:: germany/pos-upgrade.png
   :align: center
   :alt: Upgrading Flectra Point of Sale from the Apps dashboard
...
.. image:: germany/fiskaly-registration.png
   :align: center
   :alt: Button to register a company through fiskaly in Flectra
...
.. image:: germany/fiskaly-keys.png
   :align: center
   :alt: fiskaly keys as displayed on Flectra
...
.. image:: germany/tss-ids.png
   :align: right
   :alt: Example of TSS ID and Client ID from fiskaly in Flectra Point of Sale
...
.. image:: germany/dsfinv-k-export-fields.png
   :align: center
   :alt: Pending DSFinV-K export on Flectra
...
- If Flectra is used in the cloud, regular backups are part of the Flectra Online service. In addition,
