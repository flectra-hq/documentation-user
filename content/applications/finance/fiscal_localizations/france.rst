...
To make the onboarding of new users easier, Flectra Enterprise's French :ref:`fiscal localization
...
.. note::
    ...
    | Should multiple files contain any "Reports à Nouveaux" (RAN) with the starting balance of the
      year, you might need to cancel those entries in the User Interface. Flectra makes those entries
      (RAN) useless.
...
Accounts in Flectra generally have a number of digits that are default for the fiscal localization. As
...
between the account codes in the FEC file and the ones already existing in Flectra is performed only on
the first six digits of the codes.

.. example::
   The account code `65800000` in the file is matched against an existing `658000` account in Flectra,
...
Journals are also checked against those already existing in Flectra to avoid duplicates, also in the
...
If you use Flectra Community, you should :doc:`upgrade to Flectra Enterprise
</administration/maintain/enterprise>` or contact your Flectra service provider.

In case of non-conformity, your company risks a fine of €7,500.

To get the certification, just follow the following steps:

- If you use **Flectra Point of Sale**, :ref:`install <general/install>` the **France - VAT Anti-Fraud
