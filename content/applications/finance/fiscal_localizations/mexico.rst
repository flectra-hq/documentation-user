...
#. Choose a PAC and purchase stamps. Currently the Mexican location in Flectra works with the following
...
#. | **Flectra Mexican localization reports (l10n_mx_reports & l10n_mx_reports_closing)**
...
#. | **Flectra Mexican XML Polizas Export (l10n_mx_xml_polizas)**
...
.. important::
   From a legal point of view, a Mexican company must use the local currency (MXN). Therefore, Flectra
