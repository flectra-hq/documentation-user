...
**Flectra Documents** allows you to store, view and manage files within Flectra.

You can upload any type of file (max 64MB per file on Flectra Online), and organize them in various
workspaces.

.. seealso::
   - `Flectra Documents: product page <https://www.flectra.com/app/documents>`_
   - `Flectra Tutorials: Documents basics <https://www.flectra.com/slides/slide/documents-basics-674>`_
   - `Flectra Tutorials: Using Documents with your Accounting App
     <https://www.flectra.com/slides/slide/using-documents-with-your-accounting-app-675?fullscreen=1#>`_
...
.. image:: documents/basic-condition-example.png
   :align: center
   :alt: Example of a workflow action's basic condition in Flectra Documents
...
.. important::
   It is recommended to have some knowledge of Flectra development to properly configure *Domain*
   filters.
...
.. image:: documents/activate-domain-condition.png
   :align: center
   :alt: Activating the domain condition type in Flectra Documents
...
.. image:: documents/domain-condition-example.png
   :align: center
   :alt: Example of a workflow action's domain condition in Flectra Documents
...
.. image:: documents/use-domain-condition.png
   :align: center
   :alt: Add a node or a branch to a workflow action's condition in Flectra Documents
...
.. image:: documents/workflow-action-example.png
   :align: center
   :alt: Example of a workflow action Flectra Documents
