...
.. image:: link_tracker/enable_link_tracker.png
   :align: center
   :alt: View of Website settings page emphasizing the link trackers field in Flectra Website
...
.. image:: link_tracker/link_tracker_fields.png
   :align: center
   :alt: View of the link tracker fields for Flectra Website
...
.. image:: link_tracker/links_statistics.png
   :align: center
   :alt: View of the tracked list emphasizing the statistics buttons in Flectra Website

.. tip::

   #. You can also access the link tracker on *flectra.com/r* via your browser.
