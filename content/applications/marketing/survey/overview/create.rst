...
.. image:: media/new_survey.png
   :align: center
   :alt: Form view of a survey with a title and category being chosen in Flectra Surveys
...
.. image:: media/sections_questions.png
   :align: center
   :alt: Sections and questions view of a survey in Flectra Surveys
...
.. image:: media/frontend_description.png
   :align: center
   :alt: Frontend of a survey showing the title and description of a survey for Flectra Surveys
...
.. image:: media/tab_options_layout.png
   :align: center
   :alt: Form view of a survey emphasizing the layout feature under options in Flectra Surveys
...
.. image:: media/user_feedback.png
   :align: center
   :alt: View list of the participations of a survey in Flectra Surveys
...
.. image:: media/analytical_page.png
   :align: center
   :alt: View of an analytical page for Flectra Surveys
