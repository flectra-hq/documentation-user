...
The Flectra Marketing Automation app automates a variety of marketing tasks by combining specific
...
.. image:: first_campaign/marketing-template-sample.png
   :align: center
   :alt: A dashboard showing the creation of a new marketing automation campaign in Flectra.
...
appear. In the node field, a custom equation can be configured for Flectra to use when filtering who
to include (and exclude) in this specific marketing campaign.

.. image:: first_campaign/filter-node.png
   :align: center
   :alt: A filter node in Flectra Marketing Automation.
