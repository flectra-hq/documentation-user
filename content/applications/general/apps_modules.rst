...
.. image:: apps_modules/apps-search-filter.png
   :align: center
   :alt: Add "Extra" filter in Flectra Apps

.. warning::
   Flectra is *not a smartphone*, and its apps shouldn't be installed or uninstalled carelessly. Apply
   ...
   - | **Flectra apps have dependencies.**
...
On some occasions, new improvements or app features are added to :doc:`supported versions of Flectra
...
may uninstall multiple apps and modules. Flectra warns you which dependent apps and modules are
affected by it.
