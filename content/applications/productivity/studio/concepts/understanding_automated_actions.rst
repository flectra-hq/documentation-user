...
| Automated actions are used to trigger actions. They are based on conditions and happen on top of
  Flectra’s default business logic.
...
.. image:: media/automated_action_flow.png
   :align: center
   :height: 270
   :alt: Flowchart to exemplify an automated action rule for Flectra Studio
...
.. image:: media/action_update_lead_example.png
   :align: center
   :alt: View of an automated action being created in Flectra Studio
