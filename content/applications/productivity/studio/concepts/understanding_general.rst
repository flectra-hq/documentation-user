...
| Flectra Studio is a toolbox that allows you to add models or adapt functionalities on top of Flectra’s
...
| Even for experienced developers, typing out code requires time. By using Flectra Studio, you can
...
One you start using Flectra Studio, you automatically create a new *module* that contains all your
...
| An Flectra **Module** can contain a number of elements, such as: business objects (models), object
...
| In object-oriented programming, models usually represent a concept from the real world.
  Example: Flectra has models for Sales Orders, Users, Countries, etc. If you were to build an
...
.. image:: media/new_app.png
   :align: center
   :alt: Overview of the main dashboard emphasizing the option to create a new app in Flectra Studio
...
| There are 2 main types of fields in Flectra: *basic (or scalar) fields* and *relational fields*.
...
| **Relational Fields** provide the option to link the data of one model with the data of another
  model.
| In Flectra, relational field types are: *One2many*, *Many2one*, *Many2many*.

.. image:: media/relational_fields.png
   :align: center
   :alt: Tables with a visual explanation of related fields for Flectra Studio
...
edited independently from the models that they represent. There are various types of views in Flectra,
and each of them represents a mode of visualization. Some examples are: *form*, *list*, *kanban*.

What is a Menu?
---------------

A **Menu** is a button that executes and action. In Flectra Studio, to create menus (models) and
rearrange their hierarchy, click on *Edit Menu*.

.. image:: media/edit_menu.png
   :align: center
   :alt: Overview of a menu being edit in Flectra Studio

.. seealso::
   - `Studio Basics <https://www.flectra.com/fr_FR/slides/studio-31>`_