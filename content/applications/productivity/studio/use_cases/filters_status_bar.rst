...
.. image:: media/filters_status_bar/sales_default_filter.png
   :align: center
   :alt: View of a filter’s rule form emphasizing the field default filter in Flectra Studio
...
.. tip::
   ...
   .. image:: media/filters_status_bar/form_view.png
      :align: center
      :alt: View of Studio emphasizing the form view button in Flectra Studio
