...
.. image:: media/views/kanban_default.png
   :align: center
   :height: 380
   :alt: View of the Kanban option being set as the default one in Flectra Studio
...
.. image:: media/views/view_editable.png
   :align: center
   :alt: View options emphasizing the editable options of a leads page in Flectra Studio
