...
| Flectra uses HTML and CSS technologies to create reports. HTML is a markup language that uses tags,
  ...
  the user. Flectra’s reports also use Bootstrap’s grid layout, which is the containers, rows, and
  columns to align content, and support Flectra's website themes.
...
.. image:: media/reports/report_typing.png
   :align: center
   :alt: View of the types of new reports in Flectra Studio
...
.. image:: media/reports/add_tab.png
   :align: center
   :alt: View of a report and the tab add in Flectra Studio
...
.. image:: media/reports/options_tab.png
   :align: center
   :alt: View of a report and the tab options in Flectra Studio
...
| **Visible for** is used to set which :doc:`groups </applications/general/flectra_basics/users>`
...
.. image:: media/reports/limit_visibility.png
   :align: center
   :alt: View of a report’s settings emphasizing the field limit visibility to groups in Flectra Studio
...
.. image:: media/reports/print_menu.png
   :align: center
   :alt: View of an invoice form emphasizing the menu print for Flectra Studio
...
.. tip::
   Actions in Flectra Studio can be undone until you *Close* the toolbox. Once you have closed Studio,
   changes can not be undone anymore.

   .. image:: media/reports/undo_redo.png
      :align: center
      :alt: View of a report being built and emphasizing the undo and redo buttons in Flectra Studio
