...
The Outlook :doc:`Mail Plugin <../mail_plugins>` needs to be configured both on Flectra and Outlook.
...
#. Open any email in your Outlook mailbox, click on the *More actions* button, and select *Flectra for
   Outlook*.

   .. image:: outlook/odoo-for-outlook.png
      :align: center
      :alt: Flectra for Outlook add-in button

#. The right-side panel can now display **Company Insights**. At the bottom, click on *Login*.

   .. image:: outlook/panel-login.png
      :align: center
      :alt: Logging in your Flectra database
   ...
   .. tip::
      ...
      To fix this issue, configure your browser to always allow cookies on Flectra's plugin page.
      ...
      and adding `download.flectra.com` to the list of `Sites that can always use cookies`.

      Once done, the Outlook panel needs to be opened again.


#. Enter your Flectra database URL and click on *Login*.

   .. image:: outlook/enter-database-url.png
      :align: center
      :alt: Entering your Flectra database URL
...
#. Select *Customize actions* under *Mail*, click on *Flectra for Outlook*, and then *Save*.

   .. image:: outlook/customize-actions.png
      :align: center
      :alt: Flectra for Outlook customized action
