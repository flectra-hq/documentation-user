...
Mail Plugins are connectors that bridge your mailbox with your Flectra database. With them, you can
interact with your Flectra database directly from your mailbox by:

- Creating leads and centralizing prospects' emails into the CRM app.
- Generating tasks in any Flectra project.
...
.. note::
   ...
   - Check out the `Lead Generation IAP service Privacy Policy
     <https://iap.flectra.com/privacy#header_3>`_.

.. seealso::
   - :doc:`../general/in_app_purchase`
   - `Flectra Tutorials: Lead Enrichment <https://www.flectra.com/r/p73>`_
