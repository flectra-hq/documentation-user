...
There are two main types of purchase agreements preconfigured in Flectra: blanket orders and call for
tenders.
...
.. image:: media/agreements-enable-purchase-agreements.png
   :align: center
   :alt: Enable purchase agreements in Flectra Purchase
...
.. image:: media/agreements-configure-types.png
   :align: center
   :alt: Configure purchase agreements types in Flectra Purchase
...
.. image:: media/agreements-set-blanket-order.png
   :align: center
   :alt: Set up a blanket order in Flectra Purchase
...
Quotation*. Flectra automatically fills in requests for quotation with the information initially
...
.. image:: media/agreements-ongoing-blanket-order.png
   :align: center
   :alt: Create new quotations for an ongoing blanket order in Flectra Purchase
...
.. image:: media/agreements-blanket-order-replenishment.png
   :align: center
   :alt: Blanket order added to product configuration in Flectra Purchase
