...
those with the closest date first is preferred. Depending on the chosen removal strategy, Flectra
...
Flectra requests a transfer for the products that have been in the stock for the longest period.
...
When a sales order for 25 units of Hand Cream is created, Flectra automatically reserves the lots with
