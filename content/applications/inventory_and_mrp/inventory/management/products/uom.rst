...
Flectra can be set up to use different units of measure for one product.

Configuration
=============

To use different units of measure in Flectra, first go to :menuselection:`Inventory --> Configuration
...
category is important for unit conversion, Flectra can only convert a product's units from one unit to
...
the :guilabel:`Uom` column of the :guilabel:`Units of Measure Categories` page. Flectra uses the
...
When creating a new request for quotation (RFQ) in the Purchase app, Flectra automatically uses the
...
button at the top right corner of the PO. Flectra automatically converts the purchase unit of measure
...
When creating a new quotation in the Sales app, Flectra automatically uses the product's specified
...
:guilabel:`Delivery` smart button at the top right corner of the SO. Flectra automatically converts
