...
By default, Flectra uses a periodic inventory valuation (also known as manual inventory valuation).
This method implies that the accounting team posts journal entries based on the physical inventory
of the company, and that warehouse employees take the time to count the stock. In Flectra, this method
...
Below are the three costing methods that can be used in Flectra for inventory valuation.

- **Standard Price**: is the default costing method in Flectra. The cost of the product is manually
...
Configure automated inventory valuation in Flectra
--------------------------------------------------
