...
In Flectra, wave transfers are actually batch transfers with an extra step: transfers are split before
...
.. image:: wave_transfers/wave-transfers-setting.png
   :align: center
   :alt: View of Flectra Inventory app settings to enable the wave transfers option.
