...
In Flectra, a **Warehouse** is the actual building/place in which a company's items are stocked.
Multiple warehouses can be set up in Flectra and the user can create moves between warehouses.
...
is not possible to link one location to multiple warehouses. In Flectra, as many locations can be
...
In Flectra, locations are structured hierarchically. Locations can be structured as a tree, dependent
...
.. image:: warehouses_locations/storage-location-warehouse-setting.png
   :align: center
   :alt: Enable the storage location feature in Flectra Inventory settings.
...
.. image:: warehouses_locations/create-new-warehouse.png
   :align: center
   :alt: Short name field of a warehouse on Flectra Inventory.

.. important::
   The :guilabel:`Short Name` appears on transfer orders and other warehouse documents. Flectra
...
.. image:: warehouses_locations/create-new-location.png
   :align: center
   :alt: Create a new warehouse location in Flectra Inventory.
