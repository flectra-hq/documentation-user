...
inventory adjustment in Flectra, the scheduled date for the next count is set on the 31st of
...
In Flectra, cycle counts are location-based. The frequency of the counts is defined by the storage
...
.. image:: cycle_counts/storage-locations-setting.png
   :align: center
   :alt: Enable Storage Locations in Flectra settings.
