...
In Flectra, inventory adjustments can be accessed through :menuselection:`Inventory --> Operations -->
Inventory Adjustments`.
...
.. note::
   ...
   counted quantity. As an extra caution measure, Flectra will ask for confirmation before applying
