...
<https://www.flectra.com/my/databases>`__ (you will have to sign in). Then click
on the `Manage Your Databases <https://www.flectra.com/my/databases/manage>`__
button.
...
* :ref:`Upgrade <upgrade_button>`
    Upgrade your database to the latest Flectra version to enjoy cutting-edge
    features
...
* **Backup**
    ...
    back up databases daily according to our Flectra Cloud SLA
...
* Contact Support
    Access our `support page <https://www.flectra.com/help>`__
...
.. warning:: Upgrading your database to a newer version of Flectra is a complex operation
...
Flectra releases new versions regularly (at least once a year), and upgrading your
database to enjoy new Flectra features is part of the Flectra Online experience.
...
since Flectra.com will test manually every database upgrade at least once and will
need to correct/adapt changes made to the standard Flectra Apps (e.g. through Studio
...
`database management page <https://www.flectra.com/my/databases>`__.
...
on the "Cog" menu. If an newer version of Flectra is available, you will see an 'Upgrade'
button.
...
Flectra.com - this could take time (up to several weeks). Subsequent requests
...
A change in standard worfklows of Flectra in new versions might require you to
change internal processes, or some of the customizations you made through Flectra
...
`Support page <https://www.flectra.com/help>`__.
...
to rename, access the `database management page <https://www.flectra.com/my/databases>`__
...
From the `database management page <https://www.flectra.com/my/databases>`__,
...
.. note::
    ...
    * It is not possible to delete a database if it is expired or linked
      ...
      `Flectra Support <https://www.flectra.com/help>`__
