...
* Admin: has access to all features of Flectra.sh.
...
as submodules in your branches to allow Flectra.sh to download them.
...
For that reason, you need to configure a deploy key for Flectra.sh,
...
.. Warning::
  ...
  `here <https://www.flectra.com/help>`_.
