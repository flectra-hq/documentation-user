...
An upgrade is switching to a newer version of Flectra (e.g., Flectra 14.0 to Flectra 15.0).

An upgrade does not cover:

* Changing :ref:`editions <upgrade-faq/editions-change>` (i.e., Community to Enterprise edition)
* Switching :ref:`hosting type <upgrade-faq/hosting-types-switch>` (i.e., On-Premise to Flectra Online
  or Flectra.sh)
...
#. Flectra processes the request automatically by running the database through an upgrade script, which
...
#. Once you have completed the testing and are happy with the result, you decide on a date and time
   when you stop users from accessing Flectra, freeze all data entries, and create an upgrade request
   for the production upgrade.
#. Flectra delivers the production database through the automated process.
#. You restore it in your Production environment a few short hours later and continue working on the
   newly upgraded database (this is done automatically on Flectra Online).

.. seealso::
   - :doc:`Upgrade process for Flectra Online <upgrade/odoo_online>`
   - :doc:`Upgrade process for Flectra.sh <upgrade/odoo_sh>`
...
<https://upgrade.flectra.com>`_ and select *Testing* purpose.
...
Every business and organization has its own operational needs and has to test its specific Flectra
...
If you encounter an issue in the **test database**, please get in touch with Flectra Upgrade Support
via the `Flectra Support page <https://www.flectra.com/help>`_.
...
If you encounter issues or problems in the **production database**, please get in touch with **Flectra
Support**:
...
Upgrade Team <mailto:upgrade@flectra.com>`_. We will be happy to answer it as soon as possible.
...
Please note that Flectra provides support and bug fixing only for the three last major versions of
Flectra.
...
Databases hosted on Flectra's Cloud platforms (Flectra Online and Flectra.sh) or On-Premise (Self-Hosting)
...
* Lines of code added to standard modules that are not created with Flectra Studio.
* `Training <https://www.flectra.com/learn>`_ on the latest version

You can get more information about your Enterprise Licence on our :ref:`Flectra Enterprise Subscription
