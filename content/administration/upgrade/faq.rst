...
* You benefit from the latest features of the :ref:`new major version
  <upgrade-faq/release-notes>` released by Flectra.
...
As soon as Flectra announces the release of a new major version, you can create a test upgrade request
to try the latest version. Please note that at this point, the upgrade scripts will only have been
tested with demo data. Please report any issue you might encounter while testing via the `Flectra
Support page <https://www.flectra.com/help>`_ and make sure to be happy with your test version before
...
An upgrade is switching to a newer version of Flectra, while a migration reflects the change of
...
The upgrade always returns an Enterprise edition of Flectra, whether the database you sent was a
community or enterprise edition. It is required to have an enterprise subscription to upgrade.

 .. note::
    If you need assistance on this matter,  please contact us via the `Flectra Support page
    <https://www.flectra.com/help>`_.

.. seealso::
   - `Editions <https://www.flectra.com/page/editions>`_

.. _upgrade-faq/hosting-types-switch:

Switching the hosting types (On-premise vs. Flectra Online vs. Flectra.sh)
==========================================================================

An upgrade does not cover a change of `Hosting types <https://www.flectra.com/page/hosting-types>`_.
...
An Flectra Online test database is available for one month by default. We can extend this trial period
upon request. For Flectra.sh or on-premise, there is no restriction.
...
If you encounter issues during the upgrade process, please contact the Flectra Support through the
`Flectra Support page <https://www.flectra.com/help>`_.
...
The Flectra Upgrade platform uses the same Privacy Policy as the rest of Flectra.com services.
...
You can learn more about privacy and data handling at Flectra by visiting our `General Data Protection
Regulation page <https://www.flectra.com/gdpr>`_.

Rolling Release (applicable to Flectra Online databases)
========================================================

This feature allows customers to upgrade their database directly from a message prompt sent to the
database administrator as soon as the new version is released. Flectra first tests the upgrade to the
...
#. To take you to your `database manager <https://www.flectra.com/my/databases/>`_ where you can
   `request an upgraded test database <https://upgrade.flectra.com/#online/>`_ and check the upgraded
...
database is unreachable. If you notice any problem after the upgrade, please report it via the `Flectra
Support page <https://www.flectra.com/help>`_.
