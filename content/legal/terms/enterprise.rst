...
channel (typically, the web form or phone numbers listed on `flectra.com/help <https://www.flectra.com/help>`_,
...
Tickets can be submitted via the web form or phone numbers listed on `flectra.com/help <https://www.flectra.com/help>`_,
...
a maintenance fee for the last 12 months, Flectra SA may charge a one-time extra fee
...
- immediately notify Flectra SA when their actual number of Users exceeds the
...
- make a reasonable use of the Hosting Services, to the exclusion of any illegal or abusive
  ...
  published at https://www.flectra.com/acceptable-use.
...
- (h) permanently delete all copies of the Customer's database in possession of Flectra SA,
  ...
  `Privacy Policy <https://www.flectra.com/privacy>`_ ;
...
Flectra SA's Privacy Policy, published at https://www.flectra.com/privacy provides up-to-date information
...
.. [#cla1] External contributions are covered by a `Copyright License Agreement <https://www.flectra.com/cla>`_
