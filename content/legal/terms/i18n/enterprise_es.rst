...
Aplicación
    ...
    `sitio web de Flectra SA <https://www.flectra.com/es_ES/>`__

Partner de Flectra
    Un ‘Partner’ de Flectra es una empresa o individuo externo a Flectra SA que ofrece servicios
    ...
    diferente o con Flectra SA directamente (sujeto a previo aviso).
...
Módulo adicional
    ...
    (por ejemplo, con Flectra Studio), que agrega características o cambia el comportamiento estándar
    de Software. Pueden haber sido desarrolladas por el Cliente, por Flectra SA, por un Partner de Flectra
...
Error/Bug
    ...
    algunas especificaciones o requisitos será considerado como un Bug a la discreción de Flectra SA
...
propio. La plataforma en la nube es ofrecida y administrada en su totalidad por Flectra SA, y el
Cliente puede acceder a ella de forma remota. Si el cliente elige la opción de instalar el Software
en un servidor propio o un sistema informático de su elección, Flectra SA no tendrá control sobre el
Software.
...
Flectra SA se compromete a no divulgar cifras individuales o mencionadas a terceros sin el
consentimiento del Cliente, y a tratar todos los datos recopilados de conformidad con la Política de
Privacidad oficial publicada en `Flectra Privacy <https://www.flectra.com/privacy/>`__
...
llamada telefónica a los numeros enlistados en `Flectra Help <https://www.flectra.com/help/>`__, o cuando
...
Cuando se corrige un Bug de cualquiera de las versiones cubiertas, Flectra SA se compromete a corregir
el error en todas las versiones cubiertas más recientes del software.

Las partes de este Acuerdo reconocen que Flectra SA no es responsable de los Bugs en el Software o en
...
actualizaciones del sitio web de Flectra SA), con la finalidad de actualizar la base de datos del
...
adicionales sin mantenimiento de Flectra). El Cliente puede enviar múltiples solicitudes de
...
Si el Cliente decide alojar sus datos en la Plataforma en la Nube, Flectra SA se compromete a
...
el nivel del servicio, disponible en `Cloud SLA <http://www.flectra.com/cloud-sla>`__.
...
pueden ser cubiertas mediante otros servicios a contratar por parte de Flectra SA. En caso que no sea
claro si una solicitud puede ser respondida por el Servicio de soporte, la decisión queda a
discreción de Flectra SA.

Disponibilidad
~~~~~~~~~~~~~~

Los tickets de soporte pueden ser enviados a través del formulario en el sitio web o a los números
de contacto que se encuentran en `Flectra Help <https://www.flectra.com/es_ES/help>`__, o cuando se
trabaje con un Partner, en el canal señalado por el Partner, sujeto a los horarios de apertura.

.. _maintenance_partner_es:

4.6 Trabajar con un Partner de Flectra
--------------------------------------

Para la corrección de Bugs, soporte y servicios de actualización, el Cliente puede trabajar un
Partner de Flectra como su principal punto de contacto, o directamente con Flectra SA.

Flectra SA subcontratará los servicios relacionados a los Módulos adicionales de mantenimiento al
Partner de Flectra, quien se convierte en el principal punto de contacto del Cliente en caso que el
Cliente decida trabajar con un Partner de Flectra. El Partner de Flectra puede contactar a Flectra SA en
nombre del Cliente para obtener asistencia de segundo nivel con respecto a las características
estándar del Software.

Si el cliente decide trabajar con Flectra SA directamente, los servicios relacionados con los módulos
adicionales de mantenimiento serán cubiertos por Flectra SA siempre que el Cliente esté alojado en la
plataforma de la nube de Flectra.
...
sido cubierto por los costos de mantenimiento durante los últimos 12 meses, Flectra SA puede cobrar una
...
Cliente en virtud de este Acuerdo, excepto cuando Flectra SA esté legítimamente obligado a pagar o
...
- Notificar por escrito a Flectra SA 30 días antes de cambiar el punto principal de contacto
  para trabajar con otro Partner de Flectra o directamente con Flectra SA
...
el Cliente es el Responsable del tratamiento. Esta data será procesada por Flectra SA cuando el Cliente
...
base de datos o una parte de su base de datos a Flectra SA por cualquier motivo relacionado con este
Acuerdo.
...
En relación a los puntos (d) y (f), el Cliente acepta proporcionar a Flectra SA información de contacto
...
El Cliente reconoce y acepta que, para proporcionar los Servicios, Flectra SA puede utilizar a terceros
como proveedores de servicios para procesar Datos Personales (en adelante “Sub-procesadores”).
Flectra SA se compromete a utilizar Sub-procesadores únicamente de conformidad con la Legislación de
Protección de Datos. Este uso estará amparado bajo un contrato entre Flectra SA y el Sub-procesador que
...
se encuentran actualmente en uso por Flectra SA para la ejecución de los Servicios.
...
De igual manera, Flectra SA puede terminar el Acuerdo inmediatamente si el Cliente no cumple con su
...
Flectra SA posee los derechos de autor o un equivalente [#cla1]_ sobre el 100% del código del Software.
Flectra SA confirma que todas las bibliotecas de software necesarias para el uso del Software están
disponibles bajo una licencia compatible con la licencia del Software.

Durante la vigencia del presente Acuerdo, Flectra SA se compromete a emplear esfuerzos comercialmente
...
- El Cliente brindará información pertinente para la resolución de problemas y, para el alojamiento
  en servidores propios, cualquier acceso que Flectra SA pueda necesitar para identificar, reproducir y
  solventar los problemas;

- Todas las cantidades debidas a Flectra SA hayan sido pagadas.

Flectra SA está obligado únicamente a reanudar la ejecución de los Servicios sin cargos adicionales en
caso que Flectra SA incumpla alguna de las garantías establecidas. Este será el único y exclusivo
...
provee a Flectra SA una licencia de derechos de autor y de patente permanente, gratis e irrevocable.


.. [#cla1] Las contribuciones externas están cubiertas por un
           `acuerdo de licencia de derechos de autor <https://www.flectra.com/cla>`__, que
           proporciona una licencia de derechos de autor y patente permanente, gratuita e
           irrevocable a Flectra SA.
...
Flectra SA no garantiza que el Software cumpla con leyes o regulaciones locales o internacionales.
