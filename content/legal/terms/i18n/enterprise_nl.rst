...
Flectra Partner
    Een Flectra Partner is een derde bedrijf of persoon, gekozen door de Klant, die met de
    Klant samenwerkt voor zijn Flectra-gerelateerde diensten. De Klant kan op elk moment
    beslissen om met een andere Flectra Partner of rechtstreeks met Flectra NV samen
    te werken (mits voorafgaande kennisgeving).

Extra Module
    Een extra module is een map met broncode bestanden of een reeks op Python
    gebaseerde aanpassingen die in een database zijn gemaakt (bijv. met Flectra Studio),
    die functies toevoegt of het standaardgedrag van de Software wijzigt.
    Het kan zijn ontwikkeld door een Klant, door Flectra NV, door een Flectra Partner
...
Flectra NV, en is op afstand toegankelijk voor de Klant. Met de Self-Hosting optie
...
Flectra NV verbindt zich ertoe om individuele of persoonlijke cijfers niet bekend te
...
akkoord om aan Flectra NV een extra vergoeding te betalen gelijk aan 300% van het
...
vermeld op https://flectra.com/help of, in geval van een samenwerking met een Flectra Partner,
...
Wanneer een Bug verholpen is in een Ondersteunde Versie verbindt Flectra NV zich ertoe
...
Voor de duur van deze Overeenkomst verbingt Flectra NV zich ertoe een "Veiligheidsadvies"
...
Flectra NV verbindt zich ertoe om de beveiligingsoplossingen voor elke beveiligingsbug
...
te gebruiken, verbindt Flectra SA zich ertoe ten minste de volgende diensten
aan te bieden:
...
Agreement-pagina op https://www.flectra.com/cloud-sla.
...
vermeld op https://www.flectra.com/help of, in geval van samenwerking met een
Flectra Partner, het door de partner verstrekt kanaal, afhankelijk van de lokale
openingstijden.

.. _maintenance_partner_nl:

4.6 Werken met een Flectra Partner
----------------------------------

Voor bugfixing-, ondersteunings- en upgradediensten kan de Klant ofwel
werken met een Flectra Partner als hoofdcontactpersoon, ofwel rechtstreeks met Flectra NV.

Als de Klant beslist met een Flectra Partner te werken, zal Flectra NV de diensten met
betrekking tot de Ondersteunde Extra Modules uitbesteden aan de Flectra Partner, die de
hoofdcontactpersoon van de klant wordt. De Flectra Partner kan namens de klant contact opnemen
met Flectra NV voor tweede niveau ondersteuning met betrekking tot de
standaardfuncties van de Software.

Als de Klant beslist rechtstreeks met Flectra NV samen te werken, worden de diensten met
betrekking tot de Ondersteunde Extra Modules geleverd *als en alleen als* de Klant
wordt gehost op het Cloudplatform van Flectra.
...
Wanneer de Klant een upgrade aanvraagt, kan Flectra NV voor elke Ondersteunde Extra
...
- Flectra NV alle toepasselijke kosten voor de Diensten van deze Overeenkomst te
  ...
  van deze Overeenkomst;
- Flectra NV onmiddellijk op de hoogte te brengen wanneer het werkelijke aantal Gebruikers
...
- 1 toegewijde Klantcontactpersoon aan te duiden voor de volledige duur van de
  Overeenkomst;
- Flectra NV 30 dagen voor het veranderen van zijn hoofdcontactpersoon schriftelijk
  in kennis te stellen dat hij met een andere Flectra Partner of rechtstreeks met
  Flectra NV wenst samen te werken.
...
- een redelijk gebruik te maken van de Hostingdiensten, met uitsluiting van illegale of
  ...
  in het Beleid voor acceptabel gebruik, beschikbaar op https://flectra.com/acceptable-use.
...
de Klant de Verwerkingsverantwoordelijke is. Deze gegevens worden verwerkt door Flectra NV wanneer
...
de Klant zijn of haar database of een deel daarvan overdraagt aan Flectra NV om welke
...
In het bijzonder verbindt Flectra NV zich ertoe:
...
- (a) de Persoonsgegevens enkel te verwerken wanneer en zoals opgedragen
  ...
  van deze Overeenkomst, tenzij de wet dit vereist, in welk geval Flectra NV de Klant hiervan
  voorafgaand in kennis stelt, tenzij de wet dit verbiedt;
- (b) ervoor te zorgen dat alle personen binnen Flectra NV die gemachtigd zijn om de
...
- (d) elk verzoek om gegevensbescherming dat is ingediend bij Flectra NV met betrekking tot de
...
- (f) de Klant te informeren indien de verwerkingsinstructies naar het oordeel van Flectra NV
...
- (h) alle kopieën van de database van de Klant die in het bezit zijn van Flectra NV definitief
  ...
  <https://www.flectra.com/privacy>`_ van Flectra NV zijn bepaald.

Met betrekking tot punten (d) tot (f) verbindt de klant zich ertoe Flectra NV te allen tijde te
...
De Klant erkent en gaat ermee akkoord dat Flectra NV voor de levering van de Diensten een beroep kan doen
op externe dienstverleners (Subverwerkers) om Persoonsgegevens te verwerken. Flectra NV verbindt zich ertoe
alleen Subverwerkers te gebruiken in overeenstemming met de Gegevensbeschermingswetgeving.
Dit gebruik zal het voorwerp zijn van een contract tussen Flectra NV en de Subverwerker dat daartoe
garanties biedt. Het Privacybeleid van Flectra NV, beschikbaar op https://www.flectra.com/privacy
biedt actuele informatie over de namen en doeleinden van Subverwerkers waarop Flectra NV
...
Bovendien kan Flectra NV de Overeenkomst onmiddellijk beëindigen in het geval dat de
...
Flectra NV bezit het auteursrecht of een gelijkwaardig recht [#cla_nl1]_ op 100 % van
...
- de Klant passende probleemoplossingsen verstrekt en, in geval van Self-Hosting,
  Flectra NV de nodige toegang verleent opdat Flectra NV de problemen zou kunnen
...
.. [#cla_nl1] Externe bijdragen worden gedekt door een `Copyright License Agreement <https://www.flectra.com/cla>`_
           die een permanente, gratis en onherroepelijke auteursrecht- en octrooilicentie
           aan Flectra NV verstrekt.
