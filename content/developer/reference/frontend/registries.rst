...
points: many features provided by the Flectra javascript framework simply look up
...
:ref:`services <frontend/services>` that should be activated by the Flectra
framework.
