...
.. currentmodule:: flectra.tools.profiler
...
Flectra provides an integrated profiling tool that allows recording all executed queries and stack
...
.. tabs::
   ...
   .. tab:: Enable from the user interface
      ...
      .. note::
         Flectra Online databases cannot be profiled.
...
Depending on the profiling options that were activated, Flectra generates different view modes that you
...
There are currently four collectors available in Flectra:
...
Flectra CLI offers a :ref:`database population <reference/cmdline/populate>` feature through the CLI
command :command:`flectra-bin populate`.
...
.. note::
   You have to define at least :meth:`~flectra.models.Model._populate` or
   :meth:`~flectra.models.Model._populate_factories` on the model to enable database population.
