...
.. warning::
    ...
    This tutorial requires knowledge about how to build a module in Flectra (see
...
It becomes clear also when you check the tax configuration in the Flectra interface (or check the docs :ref:`Tax References <reference/account_tax>`, :ref:`Tax Repartition References <reference/account_tax_repartition>`).
