...
* Copy this `data file <https://github.com/flectra/technical-training-solutions/blob/2.0-K_dashboard/estate/data/estate_demo.xml>`__
  into a new directory called ``data`` in your estate module and copy
  `these lines <https://github.com/flectra/technical-training-solutions/blob/2.0-K_dashboard/estate/__manifest__.py#L21-L23>`__
...
`solution code <https://github.com/flectra/technical-training-solutions/blob/2.0-K_dashboard/estate/views/estate_property_views.xml#L169-L191>`__
...
``flectra/flectra/tools``, which is full of all sort of useful helper methods you will probably use in
