...
.. code-block:: console
  ...
  $ ./flectra-bin --addons-path=... -d db -i account --without-demo=all
...
.. note:: ``flectra-bin -i module`` will bypass this setting and always load the data. But normally
...
* For more complex imports like for the
  `translations <https://gitlab.com/flectra-hq/flectra/blob/e1f8d549895cd9c459e6350430f30d541d02838a/flectra/addons/base/models/ir_translation.py#L24>`__.
* It can be necessary to
  `initialize the database <https://gitlab.com/flectra-hq/flectra/blob/e1f8d549895cd9c459e6350430f30d541d02838a/flectra/addons/base/data/base_data.sql>`__.
