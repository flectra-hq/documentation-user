...
We have seen in the :ref:`previous chapter <howto/rdtraining/06_firstui>` that Flectra is able to
...
.. code-block:: console
    ...
    $ ./flectra-bin --addons-path=../custom,../enterprise/,addons -d rd-demo -u estate --dev xml
