...
At the end of the :ref:`previous chapter <howto/rdtraining/03_newapp>`, we were able to create an Flectra
...
(name, description, price, living area...) in a database. The Flectra framework provides tools to
