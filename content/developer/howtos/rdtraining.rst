...
give you an insight of the most important parts of the Flectra development framework.
The chapters should be followed in their given order since they cover the development of a new
Flectra application from scratch in an incremental way. In other words, each chapter depends on the
previous one.
...
of an Flectra module, so it's a good idea to give them a quick look.
