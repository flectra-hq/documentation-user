...
* Copy this `data file
  <https://github.com/flectra/technical-training-solutions/blob/{BRANCH}-J_reports/estate/data/estate_demo.xml>`_
  into a new directory (data) in your estate module and copy `these lines
  <https://github.com/flectra/technical-training-solutions/blob/{BRANCH}-J_reports/estate/__manifest__.py#L21-L23>`_
...
example, the ``binding_model_id`` specifies which model's views the report should show, and Flectra
