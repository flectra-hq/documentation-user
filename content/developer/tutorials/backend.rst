...
.. exercise:: Module creation
   ...
   Use the command line above to  create an empty module Open Academy, and install it in Flectra.
...
.. tip::
   ...
   After making some changes, do not forget to use :ref:`flectra-bin -u openacademy
...
.. tip::
   The Portable Object files generated by Flectra are published on `Transifex
   <https://www.transifex.com/flectra/public/>`_, making it easy to translate the software.
