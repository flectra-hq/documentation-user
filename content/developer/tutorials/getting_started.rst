...
Welcome to the Getting Started Flectra tutorial! If you reached this page that means you are
interested in the development of your own Flectra module. It might also mean that you recently
joined the Flectra company for a rather technical position. In any case, your journey to the
technical side of Flectra starts here.

The goal of this tutorial is for you to get an insight of the most important parts of the Flectra
development framework while developing your own Flectra module to manage real estate assets. The
chapters should be followed in their given order since they cover the development of a new Flectra
application from scratch in an incremental way. In other words, each chapter depends on the previous
one.

.. attention::
   Are you following this tutorial as part of your technical onboarding as an Flectra employee? Then,
