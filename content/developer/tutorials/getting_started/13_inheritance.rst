...
:meth:`~flectra.models.Model.unlink` method, you will almost always want to write a new method with
the decorator :func:`~flectra.api.ondelete` instead. Methods marked with this decorator will be
called during :meth:`~flectra.models.Model.unlink` and avoids some issues that can occur during
uninstalling the model's module when :meth:`~flectra.models.Model.unlink` is directly overridden.
...
.. exercise:: Add business logic to the CRUD methods.
    ...
    Tip: create a new method with the :func:`~flectra.api.ondelete` decorator and remember that
