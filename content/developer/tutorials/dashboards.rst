...
adding both the Community module and its necessary Professional module dependencies to its manifest.
You will commonly see "professional" in the module's directory name. To keep this tutorial simple, we
...
`viewable here <https://github.com/flectra/professional/blob/6fd3244ae168dc73c348a9c1870796e89d8ef594/crm_professional/views/crm_lead_views.xml#L106-L133>`__
...
* Copy this `data file
  <https://github.com/flectra/technical-training-solutions/blob/{BRANCH}-K_dashboard/estate/data/estate_demo.xml>`_
  into a new directory called ``data`` in your estate module and copy `these lines
  <https://github.com/flectra/technical-training-solutions/blob/{BRANCH}-K_dashboard/estate/__manifest__.py#L21-L23>`_
...
PostgreSQL aggregate function plus the special Flectra defined ``count_distinct``.
...
<https://github.com/flectra/technical-training-solutions/blob/{BRANCH}-K_dashboard/estate/views/estate_property_views.xml#L169-L191>`_
...
``flectra/flectra/tools``, which is full of all sorts of useful helper methods you will probably use in
