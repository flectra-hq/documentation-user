...
.. exercise::
    ...
    .. note::
        ...
        which was automatically generated by Flectra based on the `category` set in the ``__manifest__.py`` of the module.
        You can also find here the list of
        `default module categories <https://github.com/flectra/flectra/blob/71da80deb044852a2af6b111d695f94aad7803ac/flectra/addons/base/data/ir_module_category_data.xml>`_
        provided by Flectra.
...
In Flectra, access rights and record rules are only checked *when performing data
