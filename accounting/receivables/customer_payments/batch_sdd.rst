...
.. image:: media/batch-sdd-mandate-form.png
   :align: center
   :alt: Fill out SEPA Direct Debit in Flectra Accounting
...
.. image:: media/batch-sdd-revoke-close.png
   :align: center
   :alt: Close or Revoke an SDD Mandate in Flectra Accounting
...
.. image:: media/batch-sdd-collect.png
   :align: center
   :alt: Start the SDD payments collection in Flectra Accounting
...
.. image:: media/batch-sdd-batch.png
   :align: center
   :alt: Create a batch payment with all the SDD payments in Flectra Accounting

Flectra then takes you to your *Batch Payment*’s form. Click on *Validate* and download the SDD XML
file.
...
.. seealso::
   ...
   * `Flectra Academy: SEPA Direct Debit Mandates (SDD) <https://www.flectrahq.com/r/Zxs>`_
   * `List of all SEPA countries
     <https://www.europeanpaymentscouncil.eu/document-library/other/epc-list-sepa-scheme-countries>`_