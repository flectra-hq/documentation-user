...
concept of Flectra (From the Accounting module, go to :menuselection:`Configuration -->
...
Once the invoice is validated, Flectra will automatically split the account
