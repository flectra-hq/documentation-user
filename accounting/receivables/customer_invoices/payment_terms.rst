...
This makes for easier *Follow-ups* and *Reconciliation* since Flectra takes each due date into account,
...
.. seealso:: 
   - :doc:`cash_discounts`
   - `Flectra Learn: Terms and Conditions (T&C) and Payment Terms <https://www.flectrahq.com/r/fpv>`_