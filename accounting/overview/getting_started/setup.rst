...
The Flectra Accounting application has an implementation guide that you
...
application <https://www.flectrahq.com/apps/modules/online/account_accountant/>`__,
you should click on Settings --> Dashborard the Implementation part to get access to the
...
overall configuration of Flectra.
