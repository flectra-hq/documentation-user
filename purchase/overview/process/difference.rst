...
products. In Flectra, the Request for Quotation is used to send your list
...
I create a Request for Quotation in Flectra with those products to my usual
...
Flectra will send to a list of suppliers I specified. Out of the 8 offers I
...
the PT, and Flectra automatically asks delivery of the items to the
supplier.
