...
Flectra allows you to set up rules so that an automatic replenishment for
...
my stock. Because the stock in chairs is now only 8 chairs, Flectra will
...
By default, Reordering Rules in Flectra are named as "OP/XXXXX" but you are
...
.. tip:: The replenishments will take place when the scheduler in the Inventory
         module runs. By default in Flectra, the schedulers will run every night at
         12:00PM.
