...
of time converting measures. Luckily in Flectra, you can handle different
...
Enter the Sale module, select :menuselection:`Configuration --> Settings`
and tick the **Unit of Measure** box.
...
Let's take the classic units of measures existing in Flectra as first
...
.. tip::
    ...
    it is not standard in Flectra (see next chapter).
