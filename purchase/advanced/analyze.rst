...
.. image:: media/analyze-reporting-dashboard.png
   :align: center
   :alt: Reporting dashboard in Flectra Purchase
...
Flectra offers several default filters you can use and combine by clicking on *Filters*. When you
select one or several filters, Flectra looks for all the orders that match at least one of the filters
...
.. image:: media/analyze-filters.png
   :align: center
   :alt: Reporting filters in Flectra Purchase
...
.. image:: media/analyze-custom-filter.png
   :align: center
   :alt: Custom reporting filter in Flectra Purchase
...
.. image:: media/analyze-switch-view.png
   :align: center
   :alt: Switch reporting view in Flectra Purchase
...
.. image:: media/analyze-graph-view.png
   :align: center
   :alt: Reporting graph view in Flectra Purchase
...
.. image:: media/analyze-pivot-view.png
   :align: center
   :alt: Pivot table view in Flectra Purchase
