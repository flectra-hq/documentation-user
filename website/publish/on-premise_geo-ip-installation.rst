...
.. note:: If you can't/don't want to locate the geoip database in ``/usr/share/GeoIP/``, you can use the ``--geoip-db`` option of the Flectra command line interface.
    ...
    .. seealso::
        - `CLI documentation <https://www.flectrahq.com/documentation/2.0/reference/cmdline.html>`_.
...
.. note:: If the curly braces are empty ``{}``, it can be for any of the following reason :
   ...
   - If a reversed proxy is used, make sure to configure it correctly. See `--proxy-mode <https://www.flectrahq.com/documentation/2.0/reference/cmdline.html#cmdoption-flectra-bin-proxy-mode>`__
