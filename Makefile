...
lessfiles = _extensions/flectra/static/*.less
_extensions/flectra/static/style.css: $(lessfiles)
...
html: _extensions/flectra/static/style.css
	$(SPHINXBUILD) -b html $(ALLSPHINXOPTS) $(BUILDDIR)/html
	@echo
	@echo "Build finished. The HTML pages are in $(BUILDDIR)/html."

i18nhtml: _extensions/flectra/static/style.css
